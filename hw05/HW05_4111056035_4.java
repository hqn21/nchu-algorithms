public class HW05_4111056035_4 extends WordChain {
    static class Vertex {
        String word;
        double count;
    ...
    Vertex[] vertices = new Vertex[2048];
    ...
    public void dfs(String current, double prob, int k) {
        ...
        Vertex srcVertex = vertices[current.hashCode() & 2047];

        if (srcVertex == null) {
            srcVertex = vertices[current.hashCode() & 2047] = new Vertex(current, 0);
