...
public class HW09 {
    ...
    public static void test(BuyPhone bp) {
        ...
        int[][] c = {{1,1},{2,4},{2,10},{5,4},{4,8},{5,5},{8,4},{10,2},{10,1}};

        int[][] aAns = {{7,10},{9,8}};
        int[][] bAns = {{8466,9643},{8789,9542},{6123,9932},{9821,7908},{6825,9745}};
        int[][] cAns = {{2,10},{4,8},{5,5},{8,4},{10,2}};
        ...
        System.out.println("Time: " + time + "ns");
        stopWatch = new StopWatch();
        result = bp.bestPhone(c);
        time = stopWatch.elapsedTime();
        System.out.println("Result: " + (Arrays.deepEquals(result, cAns) ? "[CORRECT]" : "[WRONG]"));
        printArray(result);
        System.out.println("Time: " + time + "ns");
        System.out.println("====================");
    }
